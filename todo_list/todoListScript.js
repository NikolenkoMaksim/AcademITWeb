document.addEventListener("DOMContentLoaded", function () {
    ...
    document.getElementById("add_button").addEventListener("click", function () {
        ...
        function setViewMode(listItem) {
            listItem.innerHTML = "<span class='note_text'></span><button class='edit_button' type='button'>Редактировать</button><button class='delete_button' type='button'>Удалить</button>";
            ...
            listItem.querySelector(".edit_button").addEventListener("click", function () {
                listItem.innerHTML = "<div><input class='edit_text' type='text'><button class='save_button' type='button'>Сохранить</button><button class='cancel_button' type='button'>Закрыть</button></div><div class='error_message_block'></div>";
